...
class DataParallelExecutorGroup(object):
    ...
    def update_metric(self, eval_metric, labels):
        ...
        """
        valid_stop = self.batch_size - self.cur_batch_pad  # do not update with padded data
        for texec, islice in zip(self.execs, self.slices):
            ...
            for label, laxis, output, oaxis in zip(labels, self.label_layouts, texec.outputs, self.output_layouts):
